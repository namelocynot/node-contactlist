...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/contacts/contact-details/contact-details.component.html":
  /*!***************************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/contacts/contact-details/contact-details.component.html ***!
    \***************************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppContactsContactDetailsContactDetailsComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _contacts_contact_details_contact_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./contacts/contact-details/contact-details.component */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"], _contacts_contact_details_contact_details_component__WEBPACK_IMPORTED_MODULE_6__["ContactDetailsComponent"], _contacts_contact_list_contact_list_component__WEBPACK_IMPORTED_MODULE_7__["ContactListComponent"]],
  ...
  /***/
  function srcAppContactsContactDetailsContactDetailsComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppContactsContactDetailsContactDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(ContactDetailsComponent, [{
        ...
        value: function createContact(contact) {
          ...
          this.contactService.createContact(contact).then(function (newContact) {
            _this3.createHandler(newContact);
          });
        }
      }, {
        key: "updateContact",
        value: function updateContact(contact) {
          ...
          this.contactService.updateContact(contact).then(function (updatedContact) {
            _this4.updateHandler(updatedContact);
          });
        }
      }, {
        key: "deleteContact",
        value: function deleteContact(contactId) {
          ...
          this.contactService.deleteContact(contactId).then(function (deletedContactId) {
            _this5.deleteHandler(deletedContactId);
          });
        }
      }]);
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _contact__WEBPACK_IMPORTED_MODULE_2__["Contact"])], ContactDetailsComponent.prototype, "contact", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function)], ContactDetailsComponent.prototype, "createHandler", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function)], ContactDetailsComponent.prototype, "updateHandler", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", Function)], ContactDetailsComponent.prototype, "deleteHandler", void 0);
    ContactDetailsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/contacts/contact-details/contact-details.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./contact-details.component.css */
      "./src/app/contacts/contact-details/contact-details.component.css")).default]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_contact_service__WEBPACK_IMPORTED_MODULE_3__["ContactService"]])], ContactDetailsComponent);
    /***/
  },
  ...
  function srcAppContactsContactListContactListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ContactListComponent(contactService) {
        ...
        this.getIndexOfContact = function (contactId) {
          return _this6.contacts.findIndex(function (contact) {
            return contact._id === contactId;
          });
        };

        this.deleteContact = function (contactId) {
          var idx = _this6.getIndexOfContact(contactId);

          if (idx !== -1) {
            _this6.contacts.splice(idx, 1);

            _this6.selectContact(null);
          }

          return _this6.contacts;
        };

        this.addContact = function (contact) {
          _this6.contacts.push(contact);

          _this6.selectContact(contact);

          return _this6.contacts;
        };

        this.updateContact = function (contact) {
          var idx = _this6.getIndexOfContact(contact._id);

          if (idx !== -1) {
            _this6.contacts[idx] = contact;
      ...
      _createClass(ContactListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.contactService.getContacts().then(function (contacts) {
            _this7.contacts = contacts.map(function (contact) {
              if (!contact.phone) {
                contact.phone = {
                  mobile: '',
                  work: ''
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_contact_service__WEBPACK_IMPORTED_MODULE_2__["ContactService"]])], ContactListComponent);
    /***/
  },
  ...
  function srcAppContactsContactServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      ...
      _createClass(ContactService, [{
        ...
        value: function getContacts() {
          return this.http.get(this.contactsUrl).toPromise().then(function (response) {
        ...
        value: function createContact(newContact) {
          return this.http.post(this.contactsUrl, newContact).toPromise().then(function (response) {
            return response.json();
          }).catch(this.handleError);
        ...
        key: "deleteContact",
        value: function deleteContact(delContactId) {
          return this.http.delete(this.contactsUrl + '/' + delContactId).toPromise().then(function (response) {
            return response.json();
          }).catch(this.handleError);
        } // put("/api/contacts/:id")
        ...
        key: "updateContact",
        value: function updateContact(putContact) {
          var putUrl = this.contactsUrl + '/' + putContact._id;
          return this.http.put(putUrl, putContact).toPromise().then(function (response) {
            return response.json();
          }).catch(this.handleError);
        }
      }, {
    ...
    ContactService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])(), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_http__WEBPACK_IMPORTED_MODULE_2__["Http"]])], ContactService);
    /***/
  },
  ...
  /***/
  function srcAppContactsContactTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    module.exports = __webpack_require__(
    /*! C:\DataPart1\Angular-Work\mean-contactlist-angular2\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
